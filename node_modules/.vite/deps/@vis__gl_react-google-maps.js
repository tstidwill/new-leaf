...
var _excluded$1 = ["children", "style", "className", "pixelOffset", "anchor", "shouldFocus", "onClose", "onCloseClick"];
var InfoWindow = (props) => {
  ...
  (0, import_react.useEffect)(
    () => {
      ...
      infoWindow2.setContent(contentContainer2);
      setInfoWindow(infoWindow2);
      setContentContainer(contentContainer2);
      return () => {
        infoWindow2.setContent(null);
        contentContainer2.remove();
        setInfoWindow(null);
        setContentContainer(null);
      };
    },
  ...
  const map = useMap();
  (0, import_react.useEffect)(() => {
    if (!contentContainer || !infoWindow || anchor === null)
      return;
